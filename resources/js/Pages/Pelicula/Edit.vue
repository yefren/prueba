...
const form = useForm({
    ...
    fecha_publicacion  :props.pelicula.fecha_publicacion,
    imagen: props.pelicula.imagen
});
const submit = () => {
    form.put(route('pelicula.update', props.pelicula.id));
};
</script>
<template>
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <BreezeInput
                                            ...
                                            v-model="form.imagen"
                                            autofocus />
                                        <span className="text-red-600" v-if="form.errors.imagen">
                                            {{ form.errors.imagen }}
                                        </span>
                                    </div>
                                </div>
